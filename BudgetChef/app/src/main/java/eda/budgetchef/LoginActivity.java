...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
  ...
  public final static String LOGIN = "eda.budgetchef.LOGIN";
   ...
   */
  private static final String[] DUMMY_CREDENTIALS = new String[]{"renato@geh.com:renato", "admin@admin.com:admin"};
  /**
